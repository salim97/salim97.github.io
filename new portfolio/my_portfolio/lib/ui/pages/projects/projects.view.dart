...
class _ProjectsViewState extends State<ProjectsView> {
  ...
  desktop() {
    ...
    body.add(_projectItem(g.projects));
    ...
    body.add(_projectItem2(g.flutter_projects));
  ...
  mobile() {
    ...
    body.add(_projectItem_mobile(g.projects));
    ...
    body.add(_projectItem2_mobile(g.flutter_projects));
  ...
  _projectItem(List<dynamic> projects) {
    final width = MediaQuery.of(context).size.width;
    final height = MediaQuery.of(context).size.height;
  ...
  _projectItem2(List<dynamic> projects) {
    final width = MediaQuery.of(context).size.width;
    final height = MediaQuery.of(context).size.height;
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text(project["subtitle"], style: widget.theme.textTheme.bodyText2!.copyWith(fontWeight: FontWeight.w400), textAlign: TextAlign.center,),
                          ),
                          Expanded(
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceAround,
  ...
  _projectItem_mobile(List<dynamic> projects) {
    final width = MediaQuery.of(context).size.width;
    final height = MediaQuery.of(context).size.height;
  ...
  _projectItem2_mobile(List<dynamic> projects) {
    final width = MediaQuery.of(context).size.width;
    final height = MediaQuery.of(context).size.height;
