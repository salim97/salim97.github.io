...
class _EducationDesktop extends StatelessWidget {
  ...
  _EducationDesktop(this.theme, this.tablet);
  ...
  Widget build(BuildContext context) {
    ...
    if (!tablet) {
      ...
      g.degrees.forEach((element) {
        body.add(_degreeReceivedItem_tablet(element, context));
      });
      body.add(_certificationReceivedItem_tablet(context));
    }
  ...
  _degreeReceivedItem_tablet(element, context) {
    final width = MediaQuery.of(context).size.width;
    final height = MediaQuery.of(context).size.height;
    List<dynamic> descriptions = element["descriptions"] as List<dynamic>;
  ...
  _certificationReceivedItem_tablet(context) {
    final width = MediaQuery.of(context).size.width;
    final height = MediaQuery.of(context).size.height;
    List<dynamic> certifications = g.certifications;
