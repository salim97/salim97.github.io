...
class _EducationViewState extends State<EducationView> {
  ...
  mobile() {
    ...
    g.degrees.forEach((element) {
      body.add(_degreeReceivedItemMobile(element));
    });

    body.add(_certificationReceivedItemMobile());
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text(certification["title"], style: widget.theme.textTheme.headline4),
                        ),
                        Padding(
                          padding: const EdgeInsets.all(8.0),
  ...
  _degreeReceivedItemMobile(element) {
    final width = MediaQuery.of(context).size.width;
    final height = MediaQuery.of(context).size.height;
    List<dynamic> descriptions = element["descriptions"] as List<dynamic>;
  ...
  _certificationReceivedItemMobile() {
    final width = MediaQuery.of(context).size.width;
    final height = MediaQuery.of(context).size.height;
    List<dynamic> certifications = g.certifications;
