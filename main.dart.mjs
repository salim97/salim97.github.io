...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1842: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1843: (x0,x1,x2) => x0.fetch(x1,x2),
      ...
      _1846: (x0,x1) => x0.forEach(x1),
      _1848: () => new AbortController(),
      _1849: x0 => x0.getReader(),
      _1850: x0 => x0.read(),
      _1851: x0 => x0.cancel(),
      _1881: (s, m) => {
        try {
      ...
      _1883: (x0,x1) => x0.test(x1),
      _1884: (x0,x1) => x0.exec(x1),
      _1885: (x0,x1) => x0.exec(x1),
      _1886: x0 => x0.pop(),
      _1888: o => o === undefined,
      _1907: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1909: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1910: o => o instanceof RegExp,
      _1911: (l, r) => l === r,
      _1912: o => o,
      _1913: o => o,
      _1914: o => o,
      ...
      _1916: o => o.length,
      _1919: (o, i) => o[i],
      _1920: f => f.dartFunction,
      _1921: l => arrayFromDartList(Int8Array, l),
      _1922: l => arrayFromDartList(Uint8Array, l),
      _1923: l => arrayFromDartList(Uint8ClampedArray, l),
      _1924: l => arrayFromDartList(Int16Array, l),
      _1925: l => arrayFromDartList(Uint16Array, l),
      _1926: l => arrayFromDartList(Int32Array, l),
      _1927: l => arrayFromDartList(Uint32Array, l),
      _1928: l => arrayFromDartList(Float32Array, l),
      _1929: l => arrayFromDartList(Float64Array, l),
      _1930: x0 => new ArrayBuffer(x0),
      _1931: (data, length) => {
      ...
      _1962: x0 => x0.index,
      _1968: x0 => x0.flags,
      _1969: x0 => x0.multiline,
      _1970: x0 => x0.ignoreCase,
      _1971: x0 => x0.unicode,
      _1972: x0 => x0.dotAll,
      _1973: (x0,x1) => x0.lastIndex = x1,
      _1978: v => v.toString(),
      _1979: (d, digits) => d.toFixed(digits),
      _1983: x0 => x0.random(),
      _1984: x0 => x0.random(),
      _1988: () => globalThis.Math,
      _3902: () => globalThis.window,
      _3966: x0 => x0.navigator,
      _4344: x0 => x0.maxTouchPoints,
      _4354: x0 => x0.platform,
